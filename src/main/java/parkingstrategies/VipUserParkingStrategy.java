...
public class VipUserParkingStrategy implements ParkingStrategy {
    ...
    public
    @Override ParkingSpot getParkingSpot(Vehicle vehicle, ParkingLotRepository parkingLotRepository) throws ParkingSpotNotFound {
        populateFittingParkingSpots();
        validateSelectedVehicleType(vehicle.getVehicleType(), fittingParkingSpots);
        return getParkingSpotFor(vehicle, parkingLotRepository);
    }
    ...
    private ParkingSpot getParkingSpotFor(Vehicle vehicle, ParkingLotRepository parkingLotRepository) throws ParkingSpotNotFound {
